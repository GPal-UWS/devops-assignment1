...
def test_main_conversion_function():
    # test the main conversion function to ensure correct conversion output
    # if this test fails, the main_conversion_function is converting incorrectly
